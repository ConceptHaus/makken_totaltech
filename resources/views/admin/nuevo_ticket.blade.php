                ...
                <div class="col-lg-4 content-img-ticket">
                    ...
                    <div class="flexbox-b mt-4">
                        <div class="file-input-plus file-input"><i class="la la-plus-circle"></i>
                            <input id="nuevoticket" ng-model="ticket.fileticket" ngf-select
                                ngf-pattern="'image/*,application/pdf'" ngf-max-size="20MB" type="file">
                        </div>
                    </div>
                </div>
                <div class="col-lg-8">
                    <form id="form" name="form" action="javascript:;">
                        <input ng-model="ticket.registro_admin" name="registro_admin"
                            ng-init="ticket.registro_admin = 1" type="text" hidden>
                        <div class="row">
                            <div class="col-sm-6 form-group mb-4">
                                <label>No. de Ticket</label>
                                <input ng-model="ticket.no_ticket" class="form-control form-control-solid" type="text"
                                    placeholder="Introduce tu número de ticket">
                            </div>
                            <div class="col-sm-6 form-group mb-4">
                                <label>Monto</label>
                                <input ng-pattern="/^$|^[0-9,]+$/" ng-model="ticket.monto"
                                    class="form-control form-control-solid" placeholder="$0.00" money />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6 form-group mb-4 dropmenu-container">
                                ...
                                <div>
                                    <select class="selectpicker form-control form-control-solid"
                                        ng-model="ticket.id_establecimiento" data-live-search="true"
                                        title="Selecciona establecimiento">
                                ...
                                <div class="mt-4" ng-if="ticket.id_establecimiento == 9">
                                    ...
                                    <div>
                                        <div class="form-group">
                                            <input id="otro_establecimiento" ng-model="ticket.otro_establecimiento"
                                                type="text" class="form-control" name="otro_establecimiento"
                            ...
                            <div class="col-sm-6 form-group mb-4 dropmenu-container">
                                ...
                                @if($user_registrado = $_GET['user_registrado'])
