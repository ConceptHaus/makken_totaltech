        ...
        <div class="ibox-body">
            ...
            <div class="flexbox mb-4">
                <div class="flexbox">
                    ...
                    <select ng-model="semana.selectTypeSemana" class="selectpicker show-tick form-control"
                        title="Selecciona" data-style="btn-solid">
                        ...
                        <tr ng-repeat="ganador in ganadores | filter:search | filter:{id_semana:semana.selectTypeSemana}"
                            ...
                            <td>
                                <a class="text-muted font-16"
                                    href="{{ url('/admin/usuarios/detalle/<% ganador.user.id %>') }}"
                                    data-container="body" data-toggle="popover" data-trigger="hover"
                                    data-placement="top" data-content="Conocer detalle de usuario."><i class="ti-layout-list-thumb-alt"></i></a>
                            </td>
                        </tr>
                    </tbody>
                </table>
