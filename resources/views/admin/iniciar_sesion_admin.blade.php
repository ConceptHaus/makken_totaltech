...
<head>
    ...
    <style>
        body {
            ...
            background-image: url(./assets/img/backgrounds/background_1.jpg);
        }
    ...
    <div style="max-width: 400px;margin: 100px auto 50px;">
        ...
        <div class="ibox login-box">
            <form class="ibox-body" id="login-form" action="javascript:;" method="POST">
                <h4 class="font-strong text-center mb-5">INICIAR SESIÓN</h4>
                <div class="form-group mb-4">
                    <input class="form-control form-control-line" type="text" name="email" placeholder="Correo">
                </div>
                <div class="form-group mb-4">
                ...
                <div class="flexbox mb-5">
                    <label class="checkbox checkbox-primary">
                        ...
                        <span class="input-span"></span> Recuérdame</label>
                    <!-- <a class="color-inherit" href="forgot_password.html">Forgot password?</a> -->
                </div>
                <div class="text-center mb-4">
                    <button class="btn btn-primary btn-rounded btn-block">ENTRAR</button>
                </div>
            </form>
        </div>
    </div>
