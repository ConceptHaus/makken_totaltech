...
<div id="dinamica" class="pt-5 container-fluid dinamica">
  ...
  <div class="row mx-3 text-center justify-content-center">
    <div class="col-sm-4 col-12 my-4 wow zoomIn" data-wow-offset="135"
      ...
      <div class="text-center">
        <h5 class="dinamica__h5 mt-3">COMPRA $200 PESOS O MÁS <br/>EN PRODUCTOS CEYS</h5>
      </div>
    </div>
    <div class="col-sm-4 col-12 my-4 wow zoomIn" data-wow-offset="135"
      data-wow-duration="1s">
  ...
  <div class="row text-center justify-content-center">
    <div class="col-lg-12 col-md-12 mt-5 mb-5 mx-2">
      <h3 class="dinamica__h6">Consulta las bases, condiciones y vigencia de la promoción <a style="    text-decoration: underline!important;" href="/avisos/TerminosyCondicionesCEYSREGALAIPHONE2024.pdf?2">aquí</a>. </h3>
...
<div class="row no-movil">
  <div class="col-lg-12 col-md-12 ">
    <!--<span class="text-fija-pega" style="font-family: 'Helvetica NeueLTSBold' !important;">CEYS</span>-->
    <img src="{{ asset('img/images/totaltech/ceyslayout.png') }}" alt="" style="    width: 100vw;
    position: relative;
    left: -.7vw;" >
  </div>
</div>
