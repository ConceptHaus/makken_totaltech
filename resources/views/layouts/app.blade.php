...
<head>
  ...
  <script>
    ...
    })(window, document, 'script', 'dataLayer', 'GTM-PK4GNK7');
  </script>
...
<body ng-app="angularApp">
  ...
  <body ng-app="angularApp" class="body-bg">
      ...
      <div class="container-fluid pt-4 pb-4 pl-5 pr-5">
        <div class="row align-items-center mx-0">
          <div class="col-lg-3 text-responsive pl-md-4 ml-lg-5 pl-lg-2">
            <p class="no-margin"><strong>SOPORTE</strong><br>
              41-600-800/900<br>
              <a class="mail-footer" href="mailto:privacidad@makken.com.mx" target="_blank">privacidad@makken.com.mx</a>
            </p>
          </div>
          ...
          <div class="col-lg-2 text-center">
            <p><a href="https://mundoceys.com/" target="_blank"
                class="mundo-link"><strong>WWW.MUNDOCEYS.COM</strong></a></p>
          </div>
          <div class="col-lg-3 text-lg-right text-center">
            <a href="https://mundoceys.com/" target="_blank"><img class="img-footer"
                src="{{ asset('img/logos/ceys-logo.svg') }}" alt="Ceys"></a>
          </div>
        </div>
      </div>
    </footer>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PK4GNK7" height="0" width="0"
