<div class="row">
  <div class="col-lg-12 col-md-12">
    <span class="text-fija-pega">¿CÓMO PARTICIPAR?</span>
  </div>
</div>
...
<div id="dinamica" class="pt-5 container-fluid dinamica">
  <div class="row mx-3 text-center justify-content-center">
    <div class="col-sm-4 col-12 my-4 wow zoomIn" data-wow-offset="135"
      ...
      <div class="text-center">
        <h5 class="dinamica__h5 mt-3">COMPRA<br/>PRODUCTOS CEYS</h5>
    ...
    <div class="col-sm-4 col-12 my-4 wow zoomIn" data-wow-offset="135"
      ...
      <div class="text-center">
        <img src="{{ asset('img/images/tarjeta/QR.png') }}" class="dinamica__qr" alt="codigoqr">
        <h5 class="dinamica__h5 mt-3">REGISTRA TU TICKET<br/>VÍA WHATSAPP<br/> <span style="color:#fadb2a">AL 5579109294</span></h5>
      </div>
    </div>
    <div class="col-sm-4 col-12 my-4 wow zoomIn" data-wow-offset="135"
      data-wow-duration="1s">
      ...
      <div class="text-center">
        <h5 class="dinamica__h5 mt-3">PARTICIPA Y RESPONDE <br/> CORRECTAMENTE A LA PREGUNTA</h5>
      </div>
    </div>
  </div>
  <div class="row text-center justify-content-center">
    <div class="col-lg-12 col-md-12 mt-5 mb-5 mx-2">
      ...
      <h2 class="dinamica__h4">www.ganaconceys.com.mx/ceystedadetodo</h2>
