  ...
  <div class="row mx-3 text-center justify-content-center">
    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 my-4 wow zoomIn" data-wow-offset="130"
      ...
      <div class="text-center">
        <h5 class="dinamica__h5 mt-3">COMPRA $300 PESOS EN PRODUCTOS DE LA MARCA CEYS</h5>
      </div>
    </div>
    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 my-4 wow zoomIn" data-wow-offset="135"
      ...
      <img src="{{ asset('img/icons/2.svg') }}" class="dinamica__pasos-img" alt="Paso 2">
      <div class="text-center">
        <h5 class="dinamica__h5 mt-3">REGISTRA EL MAYOR NÚMERO DE TICKETS DE COMPRAS HECHAS EN TIENDAS FÍSICAS O EN LÍNEA.</h5>
      </div>
    </div>
    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 my-4 wow zoomIn" data-wow-offset="135"
      data-wow-duration="1s">
      <!-- <img src="{{asset('img/icons/paso_3.svg')}}" class="dinamica__pasos-number" alt="Paso 3"> -->
      <img src="{{ asset('img/icons/3.svg') }}" class="dinamica__pasos-img" alt="Paso 3">
      <div class="text-center">
        <h5 class="dinamica__h5 mt-3">GANA UN DRON CADA SEMANA</h5>
      </div>
    </div>
  </div>
  <div class="row text-center justify-content-center">
