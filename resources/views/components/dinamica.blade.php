...
<div id="dinamica" class="pt-5 container-fluid dinamica">
  <div class="row text-center justify-content-center">
    <div class="col-lg-12 col-md-12 col-12 my-md-4 py-md-3 my-sm-3">
      <h1 class="dinamica__h1">¿CÓMO PARTICIPAR?</h1>
    </div>
  </div>
  <div class="row mx-3 text-center justify-content-center">
    <div class="col-sm-4 col-12 my-4 wow zoomIn" data-wow-offset="135"
      ...
      <div class="text-center">
        <h5 class="dinamica__h5 mt-3">COMPRA $200 PESOS O MÁS <br/>EN PRODUCTOS MONTACK</h5>
      </div>
    </div>
    <div class="col-sm-4 col-12 my-4 wow zoomIn" data-wow-offset="135"
      data-wow-duration="1s">
      ...
      <div class="text-center">
        ...
        <h5 class="dinamica__h5 mt-3">ENTRA A<br/>GANACONCEYS.COM.MX/MONTACK Y CREA TU CUENTA</h5>
      </div>
    </div>
    <div class="col-sm-4 col-12 my-4 wow zoomIn paso_tres" data-wow-offset="135"
      ...
      <div class="text-center">
        ...
        <h5 class="dinamica__h5 mt-3">REGISTRA TU TICKET O TICKETS DE COMPRA <br/> DE THE HOME DEPOT</h5>
      </div>
    </div>
  </div>
  <div class="row text-center justify-content-center">
    <div class="col-lg-12 col-md-12 mt-5 mb-5 mx-2">
      <h3 class="dinamica__h6">Consulta las bases, condiciones y vigencia de la promoción <a style="    text-decoration: underline!important;" href="/avisos/TerminosyCondicionesMONTACK2024.pdf?4">aquí</a>. </h3>
      <a href="https://ganaconceys.com.mx/montack"><h2 class="dinamica__h4">www.ganaconceys.com.mx/montack</h2></a>
