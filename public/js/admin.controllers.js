...
app.controller("adminCtrl", function ($scope, AdminFactory, $http, $window, Upload, CSRF_TOKEN) {
  ...
  $scope.getCP = function (cp) {
    $http.get('/api/v1/cp/' + cp).then(function (res) {
      ...
      $scope.user.municipio = res.data.Municipio; // console.log($scope.user);
    }, function (error) {
...
module.exports = __webpack_require__(/*! /Users/eiichimatsuo/Desktop/ConceptHaus/makken_totaltech/resources/assets/js/angular-app/admin/admin.controllers.js */"./resources/assets/js/angular-app/admin/admin.controllers.js");
